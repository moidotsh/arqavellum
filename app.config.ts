// app.config.ts
// Arqavellum is PWA-first; native export is an intentional consumer extension.
...
// `app.arqavellum` are starter scaffolding — the consumer replaces them with
...
const config: ExpoConfig = {
  ...
  ios: {
    supportsTablet: true,
    newArchEnabled: true,
    bundleIdentifier: 'app.arqavellum',
    infoPlist: {
